        ...
        <div class="col-md-6 right-box">
            <div class="row align-items-center">
                ...
                <form method="POST" action="index.php?page=daftarPasien">
                    ...
                    <div class="form-group mb-3">
                        <button class="btn btn-lg btn-success w-100 fs-6" type="submit" style="background-color: #0A5EB0;">Cari</button>
                    </div>
                    <div class="text-center">
                        <p class="mt-3"><a>Belum terdaftar? </a><a href="index.php?page=daftarPasienBaru" style="text-decoration: none; color: #0A5EB0;">Mendaftar pasien baru</a></p>
                    </div>
                </form>
            </div>
        </div> 
