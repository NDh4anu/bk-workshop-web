            ...
            <div class="row align-items-center">
                ...
                <form method="POST" action="index.php?page=daftarPasienBaru">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="no_hp" class="form-control form-control-lg bg-light fs-6" placeholder="Masukkan No Handphone" required>
                    </div>
                    
                    <div class="form-group mb-3">
                        <button class="btn btn-lg btn-success w-100 fs-6" type="submit" style="background-color: #0A5EB0;">Daftar</button>
                    </div>
                    <div class="text-center">
                        <p class="mt-3"><a>Sudah terdaftar? </a><a href="index.php?page=daftarPasien" style="text-decoration: none; color:#0A5EB0;">Masuk pasien</a></p>
                    </div>
                </form>
            </div>
        </div> 
