                                        ...
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <div class="text">
                                                    ...
                                                    <h2>Pasien - Dokter</h2>
                                                    <span>Poliklinik Terbaik yang ada di Kota Anda.</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="schedule-inner">
                                    <div class="row d-flex align-item-center justify-content-center">
                                        <div class="col-lg-4 col-md-6 col-12 ">
                                            <!-- single-schedule -->
                                            <div class="single-schedule first" style="background-color: #D4EBF8; border-radius: 15px;">
                                                <div class="inner">
                                                    <div class="icon">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            <div class="single-schedule middle" style="background-color: #D4EBF8;  border-radius: 15px;"">
                                                <div class="inner">
                                                    <div class="icon">
