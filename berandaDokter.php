                                ...
                                <div class="col-md-6">
                                    <div class="detail-box">
                                        <div class="heading_container">
                                            <h3>
                                                Selamat datang di Poliklinik! <span></span>
                                            </h3>
                                        </div>
                                        <p class="aboutpoli" style="font-size: 16px;">
                                            ...
                                            Dengan staf medis yang berpengalaman dan fasilitas terkini, Poliklinik menjadi pilihan utama untuk perawatan kesehatan Anda.
                                        </p>
                                    </div>
                                </div>
                            </div>
