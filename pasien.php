                ...
                <div class="card-body">
                    <form class="form row" style="width: 30rem;" method="POST" action="" name="myForm" onsubmit="return(validate());">
                        ...
                        <div class="row">
                            ...
                            <div>
                                <input type="text" class="form-control" name="nama" id="inputNama" placeholder="Nama" value="<?php echo htmlspecialchars($nama); ?>">
                            </div>
                        </div>
                        <div class="row mt-1">
                            ...
                            <div>
                                <input type="text" class="form-control" name="alamat" id="inputAlamat" placeholder="Alamat" value="<?php echo htmlspecialchars($alamat); ?>">
                            </div>
                        </div>
                        <div class="row mt-1">
                            ...
                            <div>
                                <input type="number" class="form-control" name="no_ktp" id="inputNoKTP" placeholder="No KTP" value="<?php echo htmlspecialchars($no_ktp); ?>">
                            </div>
                        </div>
                        <div class="row mt-1">
                            ...
                            <div>
                                <input type="number" class="form-control" name="no_hp" id="inputNoHP" placeholder="No Handphone" value="<?php echo htmlspecialchars($no_hp); ?>">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col">
                                <button type="submit" class="btn btn-primary rounded-pill px-3 mt-auto" name="simpan" style="background-color: #0A5EB0;">Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center"><?php echo htmlspecialchars($data['no_rm']); ?></td>
                    <td class="d-flex justify-content-center">
                        <div class="d-flex gap-2 mb-3">
                            <a type="button" class="btn btn-success rounded-pill px-3" href="index.php?page=pasien&id=<?php echo htmlspecialchars($data['id']); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                </svg>
                            </a>
                            <a type="button" class="btn btn-danger rounded-pill px-3" href="index.php?page=pasien&id=<?php echo htmlspecialchars($data['id']); ?>&aksi=hapus">
